    ...
    <Box sx={styles.forBox}>
      ...
      <div className={show ? style.descriptionFull : style.description}>
        <p className={style.text}>
          Restaurant "Sushi Store" offers our customers the most delicious sushi
          with home delivery, cooked according to classic and adapted to the
          European audience recipes, as well as our own experience of our chefs.
          We appreciate the time of our customers, so you can order sushi in
          Warsaw with home delivery or office.
        </p>
        <p className={style.text}>
